...
<header class="flex justify-between items-center bg-white border-b  border-b-gray-300 px-8">
	<div class="p-4">
		<a class="text-lg font-bold text-gray-700 flex content-center gap-2" href="/">
			<img class="h-8" src={logo} alt="Svelte Cabins" />
            <div>Svelte Cabins</div>
		</a>
	</div>
